...
class FuzzyInference:
    ...
    def initFuzzySystem(self):
        ...
        capacity.add_trapezoidal('Medium', 0.5 * MAX_CAPACITY, 0.6 * MAX_CAPACITY, 0.7 * MAX_CAPACITY,
                                 0.8 * MAX_CAPACITY)
        ...
        thetaValue.add_trapezoidal('Low', 0.1, 0.15, 0.35, 0.4)
        thetaValue.add_trapezoidal('Medium', 0.35, 0.4, 0.6, 0.65)
        thetaValue.add_trapezoidal('High', 0.6, 0.65, 0.85, 0.9)
